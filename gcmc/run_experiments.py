...
def grid_search():
    ...
    for input_rate in input_rates:
        for rate in dropout_rates:
            ...
            os.system("python train.py -d {} --accum {} -ado {} -fdo {} -nleft -nb 2 -e {} -wf {} --testing -ne {} -fi node --features -attn".format(data_set,accum,input_rate,rate,num_itr,out_file_name,itr_times))
